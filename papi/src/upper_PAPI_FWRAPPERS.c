...
void PAPIF_EPC ( int *EventCode, float *rtime, float *ptime, long long *ref, long long *core, long long *evt, float *epc, int *check)
...
void PAPIF_FLIPS_RATE ( int *EventCode, float *real_time, float *proc_time, long long *flpins, float *mflips, int *check )
...
void PAPIF_FLOPS_RATE ( int *EventCode, float *real_time, float *proc_time, long long *flpops, float *mflops, int *check )
