...
void papif_epc_ ( int *EventCode, float *rtime, float *ptime, long long *ref, long long *core, long long *evt, float *epc, int *check)
...
void papif_flips_rate_ ( int *EventCode, float *real_time, float *proc_time, long long *flpins, float *mflips, int *check )
...
void papif_flops_rate_ ( int *EventCode, float *real_time, float *proc_time, long long *flpops, float *mflops, int *check )
